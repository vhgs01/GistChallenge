...
import br.com.hugo.victor.gistchallenge.activity.util.Util;
...
public class PersonListAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        try {
            View view = LayoutInflater.from(mContext).inflate(R.layout.item_developer, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        try {
            ...
            holder.ivLinkedin.setVisibility(mLinkedins[position].equals("nd") ? View.GONE : View.VISIBLE);
